...
setwd("~/path/data/jacobs/mixcr/primary_rnaseq/")

# get the list of samples: patients, SRA files, Primary/Relapse status
meta <- read_tsv("~/path/data/jacobs/metadata/primary_samples_rnaseq.tsv")
...
# save the table
write.xlsx(tb3, file="RNAseq_Primary_nt_sequences.xlsx")
